...
def plot_binbox(datadict:OrderedDict, title, logy=False, size=None):
    ...
    bp = plt.boxplot(data_list, 0, '', showmeans=True, patch_artist=True)
    ...
    upper_labels_median = ['{:.3f}'.format(s) for s in medians]
    upper_labels_mean = ['{:.3f}'.format(s) for s in means]
